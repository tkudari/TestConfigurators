...
public class TestingOneWallpaperTest extends AndroidTestCase {
	...
	@UiThreadTest
	public void testOneWallpapers() {
		String featureAssetValue = "wallpapers";
		String featureName = "Wallpaper";
