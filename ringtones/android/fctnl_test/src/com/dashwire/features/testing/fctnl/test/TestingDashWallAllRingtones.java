...
public class TestingDashWallAllRingtones extends AndroidTestCase {
	...
	@UiThreadTest
	public void testDashwallAllRingtones() {
		try {
			String screenToTest = "android.settings.SOUND_SETTINGS";

			featuresTestingControllerService.testFeature("dashwall_21", null, null, screenToTest);
			featuresTestingControllerService.testFeature("dashwall_22", null, null, screenToTest);
			featuresTestingControllerService.testFeature("dashwall_23", null, null, screenToTest);
			featuresTestingControllerService.testFeature("dashwall_24", null, null, screenToTest);
