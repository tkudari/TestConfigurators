...
public class TestingDashWallAllShortcuts extends AndroidTestCase {
	...
	@UiThreadTest
	public void testDashwallAllShortcuts() {
		try {
			String screenToTest = Intent.ACTION_MAIN;

			if (featuresTestingControllerService.isFeaturesTestingControllerReady()) {
				featuresTestingControllerService.testFeature("dashwall_41", null, null, screenToTest);
				featuresTestingControllerService.testFeature("dashwall_42", null, null, screenToTest);
				featuresTestingControllerService.testFeature("dashwall_43", null, null, screenToTest);
			}
			...
			assertTrue(featuresTestingControllerService.getSuccessFeaturesQueueLength() >= 3);
		} finally {
