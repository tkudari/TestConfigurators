...
import com.dashwire.configurator.controller.ConfiguratorControllerService;
...
public class AccountConfiguratorTest {
    ...
    private Intent generateFeatureIntent(String login, String password, boolean syncEmail, boolean syncContacts, boolean syncCalendar) throws JSONException {
        ...
        return generateFeatureIntent(featureName, configIntent);
    }
    
    private static String getFeatureConfiguratorIntentAction(String featureName)
    {
        String intentAction = "com.dashwire.configure.intent." + featureName;
        return intentAction;
    }
    
    public static Intent generateFeatureIntent(String featureName, Intent receivedIntent) {
        String intentAction = getFeatureConfiguratorIntentAction(featureName);
        ...
        while (iterator.hasNext()) {
            ...
            featureConfiguratorIntent.putExtra(nextKey, receivedIntent.getExtras().getString(nextKey));
        }
