...
public class DWall_intg_test extends ActivityInstrumentationTestCase2{
	...
	private static final String TARGET_PACKAGE_ID="com.dashwire.touchwall.sprint";
	...
	public DWall_intg_test()throws ClassNotFoundException{ 
...
//	DWall_intg_test_helper.clickOnButton(endButton,solo);
//
//	DWall_intg_test_helper.wait(3000);
//	
//	Assert.assertTrue(result);
//
//}		
